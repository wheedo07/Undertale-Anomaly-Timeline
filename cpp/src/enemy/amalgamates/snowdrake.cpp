        ...
        switch(option) {
            ...
            case 3: { // 농담하기
                if(is_act[option] == 0) {
                    ...
                    box->blitter_print({ 
                        String::utf8("* 당신은 더 이상 농담이 생각나지 않는다."),
                        String::utf8("* 융합체는 계속해서 '스노위'라는 단어를 반복한다.")
                    });
                }
                break;
            }
